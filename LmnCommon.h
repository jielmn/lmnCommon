...
COMMONLMN_API   LmnThrdHandle   LmxCreateThread( POnThreadMessage pfnOnMessage, BOOL bCreateThrd = TRUE, void * pContext = 0, BOOL bDetach = FALSE, DWORD dwMaxMsgCnt = 0 );
...
COMMONLMN_API   int             LmxPostMessage( LmnThrdHandle h, const LmxMsgData * pMsgData, const char * szFile = 0, DWORD dwLine = 0 );
// 延时时间最长
COMMONLMN_API   int             LmxPostDelayMessage( LmnThrdHandle h, const LmxMsgData * pMsgData, DWORD dwDelayedMs, const char * szFile = 0, DWORD dwLine = 0 );
...
COMMONLMN_API  DWORD LmnGetFilePos( FILE * fp );

COMMONLMN_API  int LmnSetFilePos( FILE * fp, long offset, int origin );
